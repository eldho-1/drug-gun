...
def train_and_save_models():
    ...
    non_drug_files = [
        os.path.join('Training Data', "lactic.csv"), 
        os.path.join('Training Data', "citric.csv"), 
        os.path.join('Training Data', "ethanol.csv"), 
        os.path.join('Training Data', "glucose.csv"),
        os.path.join('Training Data', "sucrose.csv")
    ]
